      ...
      <nav className="flex gap-8">
        ...
        >
          ...
          <div className="text-white flex flex-col items-center gap-4">
            <ul className="flex flex-col items-center text-center gap-4 w-full">
              {navItems.map((mobileMenuItem) => (
                <li
                  className="cursor-pointer font-semibold border-b border-white w-full pb-4 hover:text-[hsl(0,94%,66%)] transition-all duration-150 ease-in-out"
                  key={mobileMenuItem}
                >
                  {mobileMenuItem}
                </li>
            ...
            <button
              className="bg-transparent font-semibold border-2 border-white w-full p-4 rounded-md cursor-pointer
                            hover:bg-white hover:text-[hsl(229,31%,21%)] transition duration-150 ease-in-out"
            >
              LOGIN
            </button>
            <nav className="flex items-center md:flex-row mt-12 gap-8">
              <a href="#">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="text-white hover:text-[hsl(0,94%,66%)] transition-all duration-150 ease-in-out"
                  width="24"
                  height="24"
                >
                  <path
        ...
        <div>
          ...
          <button
            className="max-md:hidden font-semibold bg-[hsl(0,94%,66%)] text-white pt-2 pb-2 pl-6 pr-6 rounded-md cursor-pointer
